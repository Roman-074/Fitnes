package hedgehog.tech.fitnes.ui.userData.currWeight
...
@AndroidEntryPoint
class RegistrationCurrWeightFragment : BaseFragment() {

    private var _binding: FragmentRegistrationCurrWeightBinding? = null
    private val binding get() = _binding!!
    private var isKg = true
    private val viewModel: RegistrationCurrWeightViewModel by viewModels()
    ...
    private fun navigateToNextFragment() {
        findNavController().navigate(
            R.id.action_registrationCurrWeightFragment_to_registrationGoalWeightFragment
        )
    }
    ...
    private fun initButtons() {
        ...
        //изменения при нажатии на кнопки переклчюения мер
        ...
        binding.convertLbBtn.setOnClickListener {
            ...
            //занесения вес в БД в килограммах
